...
public class ApiResource {
    ...
    @Produces(MediaType.APPLICATION_JSON)
    public List<Book> findBooksByCategoryName(@PathParam("category-id") long categoryId,
                                        @Context HttpServletRequest httpRequest) {
        try {
    ...
    public List<Book> suggestedBooksByCategoryName(@PathParam("category-name") String categoryName,
                                     ...
                                     @Context HttpServletRequest request) {
        try {
            return bookDao.findSuggestedBooksByCategoryName(categoryName, limit);
        } catch (Exception e) {
            throw new ApiException("find suggested books via categoryName failed", e);
        }
    }
